app.factory('TransactionResources', function ($location, $resource) {
    ...
    return $resource(base_url + '/api/v1/pemesanan/', {}, {
...
app.controller('ReportController', function($scope, $http, $location, TransactionResources, RuteResources, PoolResources){
	...
	$scope.update_list = function(){
		TransactionResources.list().$promise.then(function (server_response) {
